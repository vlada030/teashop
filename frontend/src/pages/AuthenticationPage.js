                    ...
                    <div className='form-container'>
                        ...
                        {!loginPage ? 
                            <div className='form-control'>
                                ...
                                <input type='text' value={username} onChange={handleUsername} placeholder='Vaše ime'/>
                            </div> : null }

                        <div className='form-control'>
                            {/* <label htmlFor='username'>Vaš e-mail</label> */}
                            <input type='email' value={email} onChange={handleEmail} ref={usernameField} placeholder='Vaš e-mail'/>
                        </div>

                        <div className='form-control'>
                            {/* <label htmlFor='password'>Vaša šifra</label> */}
                            <input type='password' value={password} onChange={handlePassword} placeholder='Vaša šifra'/>
                        </div>
                        
                        <button className='btn submit-btn' type='submit'>Pošalji</button>
                       
                        <p className='registration'>{loginPage ? 'Ukoliko nemate nalog, najpre se' : 'Povratak na'}
                            <button onClick={handleToggleForm}> {loginPage ? 'registrujte' : 'prijavu'}</button>
                        </p>
